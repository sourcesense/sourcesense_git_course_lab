1. Effetua l'operazione di 'clone' di una repository git (puoi prendere come repository remota, le seguente: https://github.com/sourcesense/sourcesense_git_course_lab.git)
```
